...
const cmd = `${npx} grpc_tools_node_protoc --plugin=protoc-gen-ts_proto="${pluginPath}" --ts_proto_out=. --ts_proto_opt=outputServices=grpc-js,env=node,esModuleInterop=true -I=. dice.proto dnd.proto game.proto`;
